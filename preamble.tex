...
\newcommand{\vnote}[1]{\authnote{Vinod}{#1}}
...
\newcommand{\minone}{\lambda_1}
\newcommand{\mini}{\lambda_i}
\newcommand{\mintwo}{\lambda_2}
\newcommand{\minn}{\lambda_n}
